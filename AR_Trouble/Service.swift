...
//  AR_Trouble
//
//  Created by Imke Beekmans on 07/05/2018.
//  Copyright © 2018 Imke Beekmans. All rights reserved.
//  Code from the Rebeloper
...
class Service: NSObject {
    ...
    static func addChildNode( node: SCNNode, toNode: SCNNode, inView: ARSCNView, cameraRelativePosition: SCNVector3){
